...
<div class="card hidden" data-id="${i}">
    ...
    $(".card .card-buttons .next").on("click", function () {
        $(this).parent().parent().parent().next().addClass("shown").prevAll().removeClass("shown");

        userAnswers.push(Number($(this).parent().parent().find(".selected").attr("value")));

        if ($(this).parent().parent().parent().attr("data-id") == questions.length - 1) {
    ...
    $(".card .card-buttons .previous").on("click", function () {
        $(this).parent().parent().parent().prev().addClass("shown").nextAll().removeClass("shown");
